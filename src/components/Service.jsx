      ...
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder-1 mb-4 t-you">You will get the <br/>perfect <span
                class="bsb-tpl-font-hw display-1 text-accent fw-normal">resolutions</span> with our proficient services.
            </h2>
          </div>
        </div>
      </div>
      ...
      <div class="container overflow-hidden">
        <div class="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-yellow text-primary  tw-bg-orange-100  p-3 mb-4">
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-green text-primary tw-bg-green-100 p-3 mb-4">
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-pink text-primary  tw-bg-pink-100 p-3 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-cyan text-primary tw-bg-green-200 p-3 mb-4">
